...
```{r overall time, echo = FALSE, message = FALSE}
...
```{r spline 2012, echo = FALSE, message = FALSE}
...
```{r spline 2016, echo = FALSE, message = FALSE}
...
```{r spline 2017, echo = FALSE, message = FALSE}
...
```{r all splines, echo = FALSE, message = FALSE}
